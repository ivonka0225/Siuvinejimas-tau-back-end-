...
function theme_stylesheets(){
	...
	$styles_path = ASSETS_URL . '/assets/styles.css';

	if( $styles_path ) {
	
		wp_register_style('fonts', 'https://fonts.googleapis.com/css?family=Merriweather:400,400i,700,700i|Open+Sans:400,400i,600,600i,700,700i,800,800i', array(), false, 'all');
        wp_register_style('styles', ASSETS_URL . '/assets/styles.css', array('fonts'), false, 'all');
